...
<AccordionGroup>
  <Accordion title="agent-vault server">
    ...
    **Environment variables:**
    ...
    | `AGENT_VAULT_FILTER_PROXY_URL` | Credential-free HTTPS callback proxy base URL advertised to remote policy filters. Plain HTTP is accepted only for a literal loopback address. |
